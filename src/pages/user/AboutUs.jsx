...
function AboutUs() {
  return <>
    ...
    <div className="row mt-3">
      <div className="col-12 col-lg-6" data-aos="fade-right" data-aos-duration="1000" data-aos-once="false">
        <img
      ...
      <div className="col-12 col-lg-6" data-aos="fade-left" data-aos-duration="1000" data-aos-once="false">
    ...
    <div className="row mt-3">
      <div className="col-12 col-lg-6 order-lg-1" data-aos="fade-left" data-aos-duration="1000" data-aos-once="false">
        <img
